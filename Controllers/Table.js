...
const table_data = async (req, res) => {
    ...
    try {
        ...
        const [results] = await pool.query('SELECT t.ISIN, t.ISIN, t.Scheme, t.Category, t.Asset_Class, t.AUM, t.PE, n.NAV, t.Equity, t.Score FROM sharad_screener.mf_table t LEFT JOIN sharad_screener.nav n ON t.ISIN = n.ISINWHERE t.Generation = (SELECT MAX(Generation) FROM sharad_screener.mf_table);');
